...
> Scraper found **1093** http, **158** socks proxies at the latest update. Usable proxies are below.
## Usage
...
|[socks4.txt](https://raw.githubusercontent.com/rawatom/freeproxylist/main/socks4.txt)|`ip_adress:port`|157|
