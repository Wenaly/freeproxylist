...
> Scraper found **855** http, **144** socks proxies at the latest update. Usable proxies are below.
## Usage
...
|File|Content|Count|
|----|-------|-----|
|[http.txt](https://raw.githubusercontent.com/rawatom/freeproxylist/main/http.txt)|`ip_address:port`|855|
