...
> Scraper found **1062** http, **136** socks proxies at the latest update. Usable proxies are below.
## Usage
...
|[socks4.txt](https://raw.githubusercontent.com/rawatom/freeproxylist/main/socks4.txt)|`ip_adress:port`|135|
